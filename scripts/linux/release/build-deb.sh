#!/usr/bin/env bash
# Build a Debian package (.deb) for Portier from the packaged runtime layout.
#
# Output:
#   build/releases/linux/portier_<version>_amd64.deb
#
# Usage:
#   bash scripts/linux/release/build-deb.sh [--version V] [--source-dir DIR] [--output-dir DIR]
#
