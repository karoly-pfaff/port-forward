...
// The platform-specific scripts (package:windows, package:macos, package:linux)
...
const platformConfig = {
  win32: {
    ...
    args: [
      ...
      "-File", "scripts\\windows\\build-executable.ps1",
  ...
  darwin: {
    cmd: "bash",
    args: ["scripts/macos/build-package.sh", `./${outputDir}`],
    shell: false,
  },
  linux: {
    cmd: "bash",
    args: ["scripts/linux/build-package.sh", `./${outputDir}`],
    shell: false,
  },
};
