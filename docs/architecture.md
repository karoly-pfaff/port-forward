...
|---|---|---|---|
| Linux | systemd unit | `scripts/linux/` | `scripts/linux/readme.md` |
| Windows | Windows service (`sc.exe`) | `scripts/windows/` | `scripts/windows/readme.md` |
| macOS | user-level LaunchAgent | `scripts/macos/` | `scripts/macos/readme.md` |
