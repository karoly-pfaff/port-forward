...
Baseline (v1.5.0): cli 93.2% (gate 93%), client 95.1%/90.1%/79.9% (gate 94/90/79), service 85.8% (gate 85%), shared 100% (gate 100/100/100), server 88.7%/91.0%/99.1% (gate 88/90/99). See `docs/coverage-baseline.md`.

v1.5.0 gates: cli `{stmts:93}`, client `{stmts:94, branch:90, funcs:79}`, server `{stmts:88, branch:90, funcs:99}`, service `{stmts:85}`, shared `{stmts:100, branch:100, funcs:100}`.
