...
Baseline (v1.5 Slice 3): cli 92.7% (gate 92%), client 94.71% (gate 94%), service 85.8% (gate 84%), shared 100% (gate 100%), server 88.63% (gate 87%). See `docs/coverage-baseline.md`.
