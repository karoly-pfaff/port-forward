...
exposes the documented route/method/status surface (`docs/openapi.json` is the
...
gate fails with a message pointing to `npm run apidoc:generate` (it never falls
