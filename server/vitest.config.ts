...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      // openapi/generate.ts and openapi/release.ts are logic-free process entries for OpenAPI
      ...
      exclude: [
        "sources/**/*.test.ts",
        "sources/testing/test-helpers.ts",
        "sources/index.ts",
        "sources/openapi/generate.ts",
        "sources/openapi/release.ts",
        "sources/**/*.schema.ts",
        "sources/forwarders/types.ts",
        "build/**",
        "*.config.ts",
      ],
    },
