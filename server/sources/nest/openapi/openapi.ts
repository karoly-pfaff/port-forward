...
/** Path of the directory this module lives in (`server/sources/nest/openapi`). */
...
export function resolveOpenApiPaths(): OpenApiPaths {
  return {
    // server/sources/nest/openapi -> server/build/api/openapi.json
    primary: join(HERE, "../../../build", OPENAPI_RELATIVE_PATH),
    // server/sources/nest/openapi -> docs/api/openapi.json
