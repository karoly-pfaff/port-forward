 ...
 *
 * The legacy Express server (`sources/legacy/`) is retained for rollback/reference
 * and can be started with `npm run start:legacy`.
 */
...
/** Root-level providers shared by the static (shadow) and live root modules. */
