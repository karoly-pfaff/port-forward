 ...
 *
 * The route validates inline with `Array.isArray(body.ids) && body.ids.every(id =>
 ...
 * DTO — `@IsArray` and `@IsString({ each: true })` both carry the identical documented
 ...
 * array is valid (a no-op reorder).
 */
